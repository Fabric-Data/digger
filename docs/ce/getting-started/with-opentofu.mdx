...
This guide assumes you completed [Configure PR automation and workflows](/onboarding/configure-pr-automation-workflows).
...
<Steps>
  <Step title="Prerequisite: OpenTaco account setup">

Complete [Set up your OpenTaco account](/onboarding/account-setup) before continuing.
  </Step>

  <Step title="Prerequisite: GitHub App installed">

Complete [Set up GitHub App](/onboarding/github-app-setup) before continuing.
