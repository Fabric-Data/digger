...
This guide assumes you completed [Configure PR automation and workflows](./configure-pr-automation-workflows).
...
Complete [Set up your OpenTaco account](./account-setup) before continuing.
  </Step>

  <Step title="Prerequisite: GitHub App installed">

Complete [Set up GitHub App](./github-app-setup) before continuing.
