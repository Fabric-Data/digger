---
title: "AWS: Separate management account setup"
description: "Use separate AWS accounts and credentials for Digger lock/state management and target infrastructure"
---
