...
inputs:
  ...
  google-service-account:
    ...
    required: false
  google-lock-bucket:
    description: The GCP bucket to use for PR locks in backendless mode (`no-backend: true`)
    required: false
  setup-azure:
...
- Quickstart (GitHub Actions): /ce/drift/quickstart-github-actions
- Notifications: /ce/drift/notifications
- Scheduling: /ce/drift/scheduling
