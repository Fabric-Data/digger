...
description: "Understand OpenTaco and choose the best onboarding path for your OpenTofu workflow"
---
...
<Note>
  ...
  See the [self-hosting docs](../ce/self-host/deploy-docker) for setup options.
</Note>
...
<Card
  ...
  icon="database"
  href="../ce/getting-started/state-management"
>
  <p>Store OpenTofu and Terraform state centrally with cloud blocks, `tofu login`, secure access controls, and rollback support. The interface is compatible with HCP Terraform for drop-in migration paths.</p>
</Card>

<Card
  title="Remote Runs (Beta)"
  icon="terminal"
  href="../ce/features/remote-jobs"
>
...
<Card
  title="PR Automation"
  icon="github"
  href="../ce/getting-started/github-app-setup"
>
